...
Last updated: 2026-09-22 21:05. v0.2.1 is live (Jan's second upload, commit 8de30af). Recipe archive (16 recipes) is on Drive (Jan uploaded the zip). v0.2.2 (Czech names for all foods) and v0.2.3 (app in English) are built and committed locally; `nutrilog-v0.2.3.zip` (contains v0.2.2 too) was sent to Jan for manual upload. Not yet confirmed live.
